...
I’m a self-taught back-end developer specializing in C++ & C#  .NET Framework. My journey into software development  began with curiosity, dedication, and a strong passion for technology.
...
- Languages : C# & C++
- Frameworks: .NET Framework, ASP.NET Core Web API (In Progress)
- Database: SQL Server, ADO.NET
- Tools: Git, GitHub, Swagger (In Progress)
***
## 🌟 Featured Projects:
